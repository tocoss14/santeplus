...
const MENUS: Record<string, { items: Item[] }> = {
  member: {
    items: [
      ...
      { to: '/app/consultations', label: 'Consultations', icon: '🩺' },
  ...
  provider: {
    items: [
      ...
      { to: '/prestataire/consultations', label: 'Consultations', icon: '🩺' },
      { to: '/prestataire/ordonnances', label: 'Ordonnances', icon: '📋' },
      { to: '/prestataire/delivrances', label: 'Délivrances', icon: '💊' },
