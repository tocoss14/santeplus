...
export const PERMISSION_LABELS: Record<string, string> = {
  ...
  'billing.view': 'Consulter la facturation prestataires',
  'billing.manage': 'Gérer la facturation prestataires',
  'commissions.read': 'Consulter les commissions',
  'commissions.manage': 'Gérer les commissions',
  'distributors.read': 'Consulter les distributeurs',
  'distributors.manage': 'Gérer les distributeurs',
  ...
  'cts.view': 'Voir les comptes techniques santé',
  'cts.manage': 'Gérer les comptes techniques (appels de fonds, clôtures)',
...
export const DEFAULT_ROLE_PERMISSIONS: Record<Role, string[]> = {
  ...
  INSURANCE_MANAGER: [
    ...
    'cts.view', 'cts.manage', 'billing.view', 'billing.manage',
    'commissions.read', 'commissions.manage', 'distributors.read', 'distributors.manage',
  ],
