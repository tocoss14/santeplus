...
async function main() {
  ...
  await prisma.$transaction([
    ...
    prisma.ctsJournal.deleteMany(),
    prisma.ctsAlert.deleteMany(),
    prisma.fundCall.deleteMany(),
    prisma.solidarityMovement.deleteMany(),
    prisma.contractClosure.deleteMany(),
    prisma.rejection.deleteMany(),
    prisma.batchInvoiceItem.deleteMany(),
    prisma.batchInvoice.deleteMany(),
    prisma.technicalAccount.deleteMany(),
  ...
  console.log('Produits v2.0 créés : Essentielle, Confort, Excellence, Entreprise Performance, Entreprise Cadre/VIP');
  ...
  console.log('  jean@demo.bj               Assuré (Santé Confort v2.0)');
  console.log('  fatou@demo.bj              Assurée (Santé Essentielle v2.0)');
